...
export const ProxyAuthenticationRequired = createHttpError("ProxyAuthenticationRequired", "ProxyAuthenticationRequired", 407);
// 408 - Request Timeout
...
export const UnsupportedMediaType = createHttpError("UnsupportedMediaType", "UnsupportedMediaType", 415);
// 416 - Range Not Satisfiable
export const RangeNotSatisfiable = createHttpError("RangeNotSatisfiable", "RangeNotSatisfiable", 416);
...
export const UnprocessableEntity = createHttpError("UnprocessableEntity", "UnprocessableEntity", 422);
// 423 - Locked
...
export const PreconditionRequired = createHttpError("PreconditionRequired", "PreconditionRequired", 428);
// 429 - Too Many Requests
export const TooManyRequests = createHttpError("TooManyRequests", "TooManyRequests", 429);
// 431 - Request Header Fields Too Large
export const RequestHeaderFieldsTooLarge = createHttpError("RequestHeaderFieldsTooLarge", "RequestHeaderFieldsTooLarge", 431);
// 451 - Unavailable For Legal Reasons
export const UnavailableForLegalReasons = createHttpError("UnavailableForLegalReasons", "UnavailableForLegalReasons", 451);
...
export const HTTPVersionNotSupported = createHttpError("HTTPVersionNotSupported", "HTTPVersionNotSupported", 505);
// 506 - Variant Also Negotiates
export const VariantAlsoNegotiates = createHttpError("VariantAlsoNegotiates", "VariantAlsoNegotiates", 506);
// 507 - Insufficient Storage
export const InsufficientStorage = createHttpError("InsufficientStorage", "InsufficientStorage", 507);
// 508 - Loop Detected
